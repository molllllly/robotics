...
static const _Goals_type_support_symbol_names_t _Goals_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, air_lab_interfaces, msg, Goals)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, air_lab_interfaces, msg, Goals)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, air_lab_interfaces, msg, Goals)() {
  return &::air_lab_interfaces::msg::rosidl_typesupport_c::Goals_message_type_support_handle;
}
