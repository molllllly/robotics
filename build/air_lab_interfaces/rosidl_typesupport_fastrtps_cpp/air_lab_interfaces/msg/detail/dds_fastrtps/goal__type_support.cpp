...
#include "air_lab_interfaces/msg/detail/goal__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const air_lab_interfaces::msg::Goal & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  air_lab_interfaces::msg::Goal & ros_message)
{
  // Member: type
  cdr >> ros_message.type;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = air_lab_interfaces::msg::Goal;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const air_lab_interfaces::msg::Goal *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<air_lab_interfaces::msg::Goal *>(
    untyped_ros_message);
...
{
  return &air_lab_interfaces::msg::typesupport_fastrtps_cpp::_Goal__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, air_lab_interfaces, msg, Goal)() {
  return &air_lab_interfaces::msg::typesupport_fastrtps_cpp::_Goal__handle;
}
