...
static const _Goals_type_support_symbol_names_t _Goals_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, air_lab_interfaces, msg, Goals)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, air_lab_interfaces, msg, Goals)),
  }
};
...
{
  return &::air_lab_interfaces::msg::rosidl_typesupport_cpp::Goals_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, air_lab_interfaces, msg, Goals)() {
  return get_message_type_support_handle<air_lab_interfaces::msg::Goals>();
}
