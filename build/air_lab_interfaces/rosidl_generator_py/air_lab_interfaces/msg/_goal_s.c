...
bool air_lab_interfaces__msg__goal__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("air_lab_interfaces.msg._goal.Goal", full_classname_dest, 33) == 0);
  }
  air_lab_interfaces__msg__Goal * ros_message = _ros_message;
  {  // type
...
PyObject * air_lab_interfaces__msg__goal__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("air_lab_interfaces.msg._goal");
